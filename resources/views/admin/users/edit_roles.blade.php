                ...
                <div class="card mb-4">
                    <div class="card-header">
                        <h4 class="card-title mb-0">
                            <i class="icon-base ti tabler-shield me-2"></i>Assign Roles
                        </h4>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            <div class="row g-2">
                                        ...
                                        <div class="form-check card p-3">
                                            ...
                                            <label class="form-check-label w-100" for="role-{{ $role->id }}">
                                                ...
                                                @if($role->permissions->count() > 0)
                                                    <br><small class="text-muted">{{ $role->permissions->count() }} permission(s)</small>
                                                @endif
                                            </label>
                                        </div>
                                    </div>
                                @empty
                                    <div class="col-12">
                                        <p class="text-muted">No roles available. <a href="{{ route('admin.roles.create') }}">Create a role first</a>.</p>
                                    @endforelse
                                </div>
                            </div>
                        </div>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        @if($permissions->count() > 0)
                            ...
                            @endforeach
                        @else
                            <p class="text-muted">No permissions available. <a href="{{ route('admin.permissions.create') }}">Create a permission first</a>.</p>
                        @endif
                    </div>
                </div>
        ...
        if (selectAllCheckbox) {
            ...
            permissionCheckboxes.forEach(cb => {
                cb.addEventListener('change', function() {
                    const allChecked = Array.from(permissionCheckboxes).every(box => box.checked);
