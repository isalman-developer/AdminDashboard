  ...
  if (typeof i18next !== 'undefined' && typeof i18NextHttpBackend !== 'undefined') {
    i18next
      ...
      .init({
        ...
        fallbackLng: 'en',
        backend: {
          loadPath: (window.assetsPath || document.documentElement.getAttribute('data-assets-path') || '/admin/assets/') + 'json/locales/{{lng}}.json'
        },
        returnObjects: true
      })
      .then(function (t) {
                ...
                return html`
                  <a href="${item.url}" class="d-flex align-items-center position-relative px-4 py-2">
                    <div class="file-preview me-2">
                      <img src="${window.assetsPath || document.documentElement.getAttribute('data-assets-path') || '/admin/assets/'}${item.src}" alt="${item.name}" class="rounded" width="42" />
                    </div>
                ...
                return html`
                  <a href="${item.url}" class="d-flex align-items-center py-2 px-4">
                    <div class="avatar me-2">
                      <img src="${window.assetsPath || document.documentElement.getAttribute('data-assets-path') || '/admin/assets/'}${item.src}" alt="${item.name}" class="rounded-circle" width="32" />
                    </div>
                    <div class="flex-grow-1">
                      <h6 class="mb-0">${item.name}</h6>
                      <small class="text-body-secondary">${item.subtitle}</small>
